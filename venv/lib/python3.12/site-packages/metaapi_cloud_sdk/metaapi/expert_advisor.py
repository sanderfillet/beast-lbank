...
from ..clients.metaapi.expert_advisor_client import ExpertAdvisorClient, ExpertAdvisorDto, NewExpertAdvisorDto
...
class ExpertAdvisor:
    ...
    def __init__(self, data: ExpertAdvisorDto, account_id: str, expert_advisor_client: ExpertAdvisorClient):
        """Initializes an expert advisor entity.
    ...
    async def reload(self):
        ...
        """
        self._data = await self._expert_advisor_client.get_expert_advisor(self._accountId, self.expert_id)
    ...
    async def update(self, expert: NewExpertAdvisorDto):
        ...
        Returns:
            A coroutine resolving when expert advisor is updated.
        """
        await self._expert_advisor_client.update_expert_advisor(self._accountId, self.expert_id, expert)
        await self.reload()
    ...
    async def upload_file(self, file: Union[str, memoryview]):
        ...
        """
        await self._expert_advisor_client.upload_expert_advisor_file(self._accountId, self.expert_id, file)
        await self.reload()
    ...
    async def remove(self):
        ...
        """
        await self._expert_advisor_client.delete_expert_advisor(self._accountId, self.expert_id)
