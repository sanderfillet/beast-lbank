...
from ..clients.metaapi.provisioning_profile_client import ProvisioningProfileDto, ProvisioningProfileClient
...
class ProvisioningProfile:
    ...
    def __init__(self, data: ProvisioningProfileDto, provisioning_profile_client: ProvisioningProfileClient):
        """Initializes a provisioning profile entity.
    ...
    async def reload(self):
        ...
        """
        self._data = await self._provisioning_profile_client.get_provisioning_profile(self.id)
    ...
    async def remove(self) -> Response:
        ...
        """
        return await self._provisioning_profile_client.delete_provisioning_profile(self.id)

    async def upload_file(self, file_name: str, file: Union[str, memoryview]) -> Response:
        ...
        """
        return await self._provisioning_profile_client.upload_provisioning_profile_file(self.id, file_name, file)
    ...
    async def update(self, profile):
        ...
        Returns:
            A coroutine resolving when provisioning profile is updated.
        """
        await self._provisioning_profile_client.update_provisioning_profile(self.id, profile)
        await self.reload()
