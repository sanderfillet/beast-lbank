...
class GetStrategiesOptions(TypedDict, total=False):
    ...
    offset: Optional[int]
    """Pagination offset. Defaults to 0. Must be greater or equal to 0."""
...
class NewWebhook(TypedDict, total=False):
...
class WebhookIdAndUrl(TypedDict, total=False):
...
class GetWebhooksOptions(TypedDict, total=False):
...
PaginationStyle = Literal['infiniteScroll', 'classic']
"""Item request pagination style."""
